  ...
  return (
    <div className="page active">
      ...
      <div className="stats-row">
        {/* 1. Assignments Card -> Links to /assignments */}
        <div 
          className="stat-card" 
        ...
        {/* 2. Reminders Card -> Links to /reminders */}
        <div 
          className="stat-card" 
        ...
        {/* 3. Cloud Files Card -> Links to /files */}
        <div 
          className="stat-card" 
      ...
      {Array.isArray(timetableData) && timetableData.length > 0 && (
        <div style={{ marginTop: '34px', marginBottom: '30px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '18px' }}>
            <div style={{ fontSize: '1.2rem', fontWeight: '700', letterSpacing: '-0.02em', color: 'var(--text-main, #ffffff)' }}>Quick Schedule</div>
          ...
          <div className="day-strip" style={{ marginBottom: '20px' }}>
            {dashboardDays.map(day => {
              const { short, full } = formatDay(day);
              return (
                <button 
                  key={day} 
                  className={`day-pill ${activeDashboardDay === day ? 'active' : ''}`}
                      ...
                      >
                        ...
                        <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                            <span style={{ fontSize: '1.05rem', fontWeight: '600', color: 'var(--text-main, #ffffff)', letterSpacing: '-0.01em' }}>
                              {baseCode}
                            </span>
                            {blockSlot && (
                              <span style={{ 
                          ...
                          <div style={{ fontSize: '0.82rem', color: 'var(--text-muted)', fontWeight: '400', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <span>🕒</span> {c.time}
                          </div>
                          ...
                          <div style={{ display: 'flex', gap: '14px', marginTop: '4px', alignItems: 'center' }}>
                            ...
                            {c.room && (
                              <div style={{ 
                                fontSize: '0.75rem', 
                                color: '#ee5b8d', 
                                background: 'rgba(238, 91, 141, 0.08)',
                                padding: '1px 8px',
                                borderRadius: '4px',
                                fontWeight: '500',
                                display: 'inline-flex',
